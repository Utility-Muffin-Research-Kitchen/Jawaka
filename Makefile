...
# Reachability guard, not a unit test: proves the input-event callback cannot
# reach SQLite. See the script header for why a grep of one function is not
# enough.
